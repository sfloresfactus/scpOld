...
Begin VB.Form DigGdFav 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Guias de Despacho Facturadas"
   ClientHeight    =   4395
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6180
...
Private Dbm As Database, RsNVc As Recordset, RsGDc As Recordset
...
m_Nv = New_Opcion
End Property
Public Property Let Rut_Cliente(ByVal New_Opcion As String)
m_Rut = New_Opcion
End Property
...
i = 0
fg.TextMatrix(i, 0) = ""
fg.TextMatrix(i, 1) = "GD"
fg.TextMatrix(i, 2) = "Fecha"
fg.TextMatrix(i, 3) = "Cliente"
...
sql = "SELECT "
sql = sql & "[GD Cabecera].NV as NV,"
sql = sql & "[GD Cabecera].Numero as numero,"
sql = sql & "[GD Cabecera].fecha as fecha,"
sql = sql & "[GD Cabecera].[RUT Cliente] as rut,"
sql = sql & "[GD Cabecera].[Precio Total] as precio,"
sql = sql & "[GD Cabecera].Factura as factura"
sql = sql & " FROM [GD Cabecera]"
...
Set RsGDc = Dbm.OpenRecordset(sql)
