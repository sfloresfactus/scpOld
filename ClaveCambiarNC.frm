...
Begin VB.Form ClaveCambiarNC 
   ...
   Begin VB.Label lblCambioClave 
      Caption         =   "Cambio Clave No Conformidades"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "ClaveCambiarNC"
...
If Validar Then
    ...
    ' graba clave nueva en tabla trabajadores
    sql = "UPDATE trabajadores SET emisor_NC_clave='" & clave(1).Text & "' WHERE rut='" & Usuario.Rut & "'"
    Db.Execute sql
