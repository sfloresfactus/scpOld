...
Load Mnu3(3)
Mnu3(3).Caption = "&Importación Masiva Planos"
Load Mnu3(4)
'Mnu3(4).Caption = "&Exportación Masiva Planos"
Mnu3(4).Caption = "&Historico de Revisiones de Planos"
Load Mnu3(5)
Mnu3(5).Caption = "Importación Pie&zas" ' nueva 11/08/10
Load Mnu3(6)
Mnu3(6).Caption = "&Cambiar Plano a otra Obra"
Load Mnu3(7)
Mnu3(7).Caption = "-"
Load Mnu3(8)
Mnu3(8).Caption = "OT &Fabricación"
Load Mnu3(9)
Mnu3(9).Caption = "OT &Especial"
Load Mnu3(10)
Mnu3(10).Caption = "-"
Load Mnu3(11)
Mnu3(11).Caption = "Informe Recepción Planos"
Load Mnu3(12)
Mnu3(12).Caption = "Informe &Planos" ' General y Detalle
Load Mnu3(13)
Mnu3(13).Caption = "Informe OT &Fabricación"
Load Mnu3(14)
Mnu3(14).Caption = "Informe OT &Especial"
Load Mnu3(15)
Mnu3(15).Caption = "Informe de Piezas"
Load Mnu3(16)
Mnu3(16).Caption = "Informe OTf x Planos" ' General y Detalle
...
'Load Mnu4(2)
'Mnu4(2).Caption = "ITO &Reproceso" 'Galvanizado" ' arenado
Load Mnu4(3)
...
Mnu5(6).Caption = "-"
Load Mnu5(7)
Mnu5(7).Caption = "&Facturas de Venta"
Load Mnu5(8)
Mnu5(8).Caption = "Informe de &Facturas"

Load Mnu5(9)
Mnu5(9).Caption = "-"
Load Mnu5(10)
Mnu5(10).Caption = "&Servicios Externos"
Load Mnu5(11)
Mnu5(11).Caption = "&Informe Servicios Externos"
Load Mnu5(12)
Mnu5(12).Caption = "-"
Load Mnu5(13)
Mnu5(13).Caption = "Entradas de Pintura"
Load Mnu5(14)
Mnu5(14).Caption = "Salidas de Pintura"
Load Mnu5(15)
Mnu5(15).Caption = "Informe Entradas de Pintura"
Load Mnu5(16)
Mnu5(16).Caption = "Informe Salidas de Pintura"
...
Load Mnu8(5)
Mnu8(5).Caption = "&Cambio Clave Usuario"
...
Load Mnu11(8)
Mnu11(8).Caption = "Importar Codigos de Productos"
...
cs = CnxSqlServer.ConnectionString
...
If KeyCode = vbKeyF4 Then
    MsgBox "Drive: " & Drive_Server & vbLf & "Path: " & Path_Mdb & vbLf & Archivo_Fecha(App.Path & "\", prg & ".exe") & vbLf & "Usuario: " & Usuario.nombre & vbLf & "App Path: " & App.Path & vbLf & _
     ...
     "Base de Datos: " & CnxSqlServer.DefaultDatabase & vbLf & _
     "Data Source: " & cs
...
Case 12 ' Planos (General) o (Detalle)
...
Case 7 'facturas de venta
'    MousePointer = vbHourglass
'    Load Factura
'    MousePointer = vbDefault
'    Factura.Show 1
Case 8 ' informe facturas
...
Case 11 ' informe servicio externos
...
Case 8
    MousePointer = vbHourglass
    Load ProductosImportar
    MousePointer = vbDefault
    ProductosImportar.Show 1
End Select
End Sub
